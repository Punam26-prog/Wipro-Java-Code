...
public class AllTest {
	 ...
	 WebDriver driver;
	    ...
	    public void Electronics() throws Exception {
	        ...
	        Actions action = new Actions(driver);
	        WebElement web = driver.findElement(By.xpath("//ul[@class='top-menu notmobile']//a[normalize-space()='Electronics']"));
	        action.moveToElement(web).perform();
	        Thread.sleep(2000);
	        driver.findElement(By.xpath("//ul[@class='top-menu notmobile']//a[normalize-space()='Camera & photo']")).click();
	        Thread.sleep(2000);
	    }
	    
	    @Test(priority=15)
	    public void addwhishlist() throws Exception {
	    	JavascriptExecutor js = (JavascriptExecutor) driver;
	        js.executeScript("window.scrollBy(0,400)", "");
	        driver.findElement(By.xpath("//div[@class='item-grid']//div[1]//div[1]//div[2]//div[3]//div[2]//button[3]")).click();
	        Thread.sleep(3000);
	    ...
	    @Test(priority=17)
	 public void Apparel() throws Exception {
	    	
	        Actions action = new Actions(driver);
	        WebElement web = driver.findElement(By.xpath("//ul[@class='top-menu notmobile']//a[normalize-space()='Apparel']"));
	        action.moveToElement(web).perform();
	        Thread.sleep(2000);
	        driver.findElement(By.xpath("//ul[@class='top-menu notmobile']//a[normalize-space()='Shoes']")).click();
	        Thread.sleep(2000);
	    }
	    ...
	    public void shoes() {
	    	JavascriptExecutor js = (JavascriptExecutor) driver;
	        js.executeScript("window.scrollBy(0,400)", "");
	        driver.findElement(By.xpath("//div[@class='picture']//img[@title='Show details for adidas Consortium Campus 80s Running Shoes']")).click();
	    }
	    
	    @Test(priority=19)
	    public void addtowhistlist() throws Exception {
	    	JavascriptExecutor js = (JavascriptExecutor) driver;
	        js.executeScript("window.scrollBy(0,400)", "");
	        
	        WebElement ramDropdown = driver.findElement(By.xpath("//select[@id='product_attribute_9']"));
	        Select select = new Select(ramDropdown);
	        select.selectByVisibleText("10");
	        Thread.sleep(2000);
	        
	        driver.findElement(By.xpath("//span[@title='Red']//span[@class='attribute-square']")).click();
	        
	        driver.findElement(By.xpath("//button[@id='add-to-wishlist-button-27']")).click();
	        Thread.sleep(2000);
	    }
	    ...
	    public void openWishlist() {
	        ...
	        WebElement wishlistButton = wait.until(ExpectedConditions.elementToBeClickable(
	            By.xpath("//span[@class='wishlist-label']")));
