...
public class JavaCollections1 {
	...
	public static void main(String[] args)
	{
		...
		depart.add(new JavaCollections1().new department("Sales", 20000,15000));
		depart.add(new JavaCollections1().new department("Marketing", 3000, 2000));
		depart.add(new JavaCollections1().new department("Research", 25000, 20000));
