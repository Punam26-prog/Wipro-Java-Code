...
public class SauceDemoLoginTest {
	...
	/* “@Test(... dataProvider = "loginData" ...) ties this method to the data.”


	“For each row, we: type credentials — > click login  — > assert based on expected.”


	“Success = URL contains /inventory.
	 Locked = error text contains ‘locked out’.
	 Invalid = error text contains ‘do not match’.” */
